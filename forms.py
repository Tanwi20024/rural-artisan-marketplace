...
class ProfileForm(FlaskForm):
    ...
    experience_years = StringField('Years of Experience', validators=[Length(max=10)])
    specialization = StringField('Specialization', validators=[Length(max=150)])
    profile_photo = FileField('Profile Photo', validators=[FileAllowed(['png', 'jpg', 'jpeg'], 'Images only!')])
